...
-- 3.1.5 Product Types (HVAC, Electrical, etc.)
CREATE TABLE IF NOT EXISTS public.tblproducttypes (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_tblproducttypes_name ON public.tblproducttypes(name);
...
-- 6.3.5 Sales Order Items (material line items for sales order materials module)
...
-- ============================================================================
-- MODULE 13.8: RBAC VIEWS
-- ============================================================================

-- 13.8.1 Effective permissions view (resolves role grants + user overrides)
